...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('SQLALCHEMY_DATABASE_URI', 
    'mysql+pymysql://event_user:your_password_here@localhost/event_management')
...
try:
    from models import User, Event, Guest, Booking, EventGuest
except ImportError:
    print("Error: models.py not found or contains errors")
